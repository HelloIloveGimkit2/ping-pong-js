...
var clolors = ["#1abc9c", "#2ecc71", "3498db", "#8c52ff", "#9b59b6"];
...
var Game = {
  ...
  update: function () {
    if (!this.over) {
      ...
      if (this.playedr.move === DIRECTION.UP) this.player.y -= this.player.speed;
      ...
      this(this.ai.y < this.canvas.height - this.ai.height) this.ai.y = this.canvas.height -
      this.ai.height;
